...
- Comandi: `make android-sync WIN=1`, poi apri **solo** `C:\dev\kor35-app\android` (`make android-path`). Path **bloccato** — non usare `C:\dev\kor35-android` né il parent `C:\dev\kor35-app`.
