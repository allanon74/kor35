...
echo "Avvio stack:"
echo "  $ROOT_DIR/scripts/up_wsl_pi_like.sh --env dev-home"
echo "  Dopo reboot WSL/Docker: $ROOT_DIR/scripts/up_wsl_pi_like.sh --env dev-home --recreate-frontend"
echo "  Riavvio senza rebuild immagini: $ROOT_DIR/scripts/up_wsl_pi_like.sh --env dev-home --no-build"
echo ""
echo "URL:"
