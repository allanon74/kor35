...
- Fasi:
  ...
  - Ripristino manuale permessi sul server (es. dopo un deploy fallito a metà): `scripts/fix_react_build_permissions.sh <path-monorepo> prod|mirror` (l’utente deve poter usare `docker` o `sudo -n docker`).
