...
function EconomiaTab({ onLogout }) {
  ...
  return (
    <div className="h-full overflow-y-auto p-4 md:p-6 bg-gradient-to-b from-slate-950 to-slate-900 text-slate-100">
      <div className="flex items-center gap-3 mb-6">
        <Wallet className="w-8 h-8 text-emerald-400" />
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Economia</h2>
          <p className="text-sm text-slate-400">Conti, trasferimento e movimenti</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
        <div className="rounded-xl border border-emerald-800/50 bg-emerald-950/40 p-4">
          ...
          <p className="text-xs text-slate-500 mt-1">Stipendio evento e trasferimenti</p>
        </div>
        <div className="rounded-xl border border-amber-800/50 bg-amber-950/30 p-4">
          ...
          <p className="text-xs text-slate-500 mt-1">Guadagni, scommesse, ricompense</p>
        </div>
        <div className="rounded-xl border border-sky-800/50 bg-sky-950/30 p-4">
          ...
          <p className="text-xs text-slate-500 mt-1">Pool unico PC</p>
        </div>
      </div>

      <section className="rounded-xl border border-slate-700 bg-slate-900/60 p-4 mb-6">
            ...
            <div className="flex flex-wrap gap-2 items-end">
              <div>
                ...
                <input
                  ...
                  step="0.01"
                  min="0"
                  className="bg-slate-800 border border-slate-600 rounded px-3 py-2 w-36"
                  value={importo}
      ...
      <section className="rounded-xl border border-slate-700 bg-slate-900/60 p-4">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          <button
            ...
            className="px-3 py-1.5 text-sm rounded bg-slate-800 border border-slate-600 hover:bg-slate-700"
          >
        ...
        {logLoading && <p className="text-sm text-slate-400">Caricamento…</p>}
        {!logLoading && logTipo && (
