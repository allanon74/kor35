...
function main() {
  ...
  fs.writeFileSync(
    ...
    [
      'Apri in Android Studio QUESTA cartella (contiene settings.gradle + gradlew).',
      '',
      'Su Windows dopo "make android-sync WIN=1":',
      '  C:\\dev\\kor35-app',
      '',
      'NON aprire:',
      '  - C:\\dev\\kor35-android  (legacy)',
      '  - una cartella "android" vuota o senza gradlew',
      '  - la parent senza i file Gradle',
      '  - \\\\wsl.localhost\\...',
      '',
    ].join('\n'),
  );
